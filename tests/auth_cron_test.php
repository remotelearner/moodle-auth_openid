...
require_once(__DIR__.'/../../../elis/core/test_config.php');
global $CFG;
require_once($CFG->dirroot.'/elis/core/lib/setup.php');
require_once(elis::lib('testlib.php'));
require_once(__DIR__.'/../auth.php');

class auth_openid_cron_testcase extends elis_database_test {
    /**
    ...
    /**
     * Initialize tables used for the overlay database system
     *
